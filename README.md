...
[ 正常版包含：3.5" 的所有的完整的内容 | 蟒蛇Users使用手册（上线及实体包装） | 用户个人信息录入及保存中心的完整使用（需要Internet及用户无法光顾） | Serpent Inc. 的吉祥物Serear蛇（仅限部分地区及需要在[Serpent Inc.官方网站](https://github.com/SteveLF-bili/Command-Line-Adventure/)上申请）]售卖2美元s
  
\> 本地化注记：  
\> • 俄罗斯版本/德国版本因"文化敏感性"删减第^%#节  
\> • 日本版本其他增加ASCII幽灵角色  
\> • 美国版本的蛇皮纹理手册第7页警告已按要求进行模糊化处理
